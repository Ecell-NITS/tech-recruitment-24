  ...
  try {
    prisma.techApplication
      ...
      .then((data) => {
        ...
        const text = `Thank you for applying to the Technical team of E-cell NIT Silchar. We will get back to you soon.In the meanwhile, you can join our WhatsApp group https://chat.whatsapp.com/GwfBBvQn3cXKjQi4S8j0Dn Please click on the link above to join the WhatsApp group.`;
        const html = `
        <h2>Thank you for applying to the Technical team of E-cell NIT Silchar.</h2>
        <p>We will get back to you soon.In the meanwhile, you can join our WhatsApp group <strong> <a href="https://chat.whatsapp.com/GwfBBvQn3cXKjQi4S8j0Dn">Ecell Tech Team Applicants 25</a></strong></p>
        <br>
